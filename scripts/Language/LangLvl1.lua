local a = 
{
  ...
  StrDlgGeneralText5 = "An Adventure begun...",
  StrDlgGeneralText6 = "Meanwhile... Chumara brings a message to Ikani...",
  ...
  StrDlgChumaraText1 = "I've to put up with Your existence for the sake of finding knowledge... Do you even understand my hassle?",
  StrDlgChumaraText2 = "...",
  StrDlgChumaraText3 = "Choose your words more wisely if you don't want to get in trouble. Complete at least this simple task and you might have my gratitude.",
  StrDlgChumaraText4 = "Our queen isn't going to be happy knowing we didn't find anything yet.",
  StrDlgChumaraText5 = "One day You'll pay for this attitude. As of now, I am returning back. Do not disappoint us.",
  StrDlgIkaniText1 = "Quit your whining missis importance, we're doing our best to find it, give it a rest.",
  StrDlgIkaniText2 = "Hahaha! Just let me handle it, besides, Tiyao is already near, isn't it a time for you to run?",
  StrDlgIkaniText3 = "Stubborn bitch. What a foolish shaman, and I am supposed to be allies with her? Ugh...",
};
